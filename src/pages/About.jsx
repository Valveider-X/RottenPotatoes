  ...
  return (
    <div className="team-members">
      ...
      <div className="member">
        ...
        <h3>Xavi Valverde</h3>
        <p>
          <b>Pequeña Descripcion</b>
        </p>
        <p>No es tan pequeña</p>
        <a href="https://github.com/Valveider-X">
          <img className="server-img" src={GitLogo} alt="Github Xavi" />
        </a>
      </div>
      ...
      <div className="member">
        ...
        <a href="https://github.com/alfom17">
          <img className="server-img" src={GitLogo} alt="Github Alfonso" />
        </a>
      </div>
      ...
      <div className="member">
        ...
        <a href="https://github.com/RonniedeTal">
          <img className="server-img" src={GitLogo} alt="Github Ronnie" />
        </a>
      </div>
    </div>
  );
